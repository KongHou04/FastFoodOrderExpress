...
public interface IProductDiscountSVC
{
    ...
    /// </summary>
    /// <param name="id">The unique identifier of the product discount.</param>
    /// <returns>A Response object containing the product discount and status information about the retrieval process.</returns>
